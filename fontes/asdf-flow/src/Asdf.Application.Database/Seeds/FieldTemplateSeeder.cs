        ...
        public static ModelBuilder SeedFieldTemplates(this ModelBuilder modelBuilder)
        {
            modelBuilder
                ...
                .HasData(
                    ...
                    new FieldTemplate() { Id = 20, NodeTemplateId = 6, Name = "Device", Type = typeof(Guid).FullName },
                    new FieldTemplate() { Id = 21, NodeTemplateId = 6, Name = "Gpio", Type = typeof(String).FullName },
                    new FieldTemplate() { Id = 22, NodeTemplateId = 6, Name = "Status", Type = typeof(GpioStatusType).FullName },

                    new FieldTemplate() { Id = 23, NodeTemplateId = 7, Name = "Name", Type = typeof(String).FullName },
                    new FieldTemplate() { Id = 24, NodeTemplateId = 7, Name = "Field", Type = typeof(String).FullName }
